...
const initPayment = async (bookingId: string) => {
  ...
  if (!payment) {
    throw new AppError(httpStatus.NOT_FOUND, "Payment Not Found. You have not booked this Product");
  }
...
const successPayment = async (query: Record<string, string>) => {
  ...
  try {
    ...
    const invoiceData: IInvoiceData = {
      ...
      quantity: updatedBooking.productCount,
      totalAmount: updatedPayment.amount,
      productName: (updatedBooking.product as unknown as IProduct).name,
